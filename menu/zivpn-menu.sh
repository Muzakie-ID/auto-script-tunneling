...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}  [1]${NC} Create ZIVPN Account"
echo -e "${GREEN}  [2]${NC} Trial ZIVPN Account ${YELLOW}(1 Hour)${NC}"
echo -e "${GREEN}  [3]${NC} Renew ZIVPN Account"
echo -e "${GREEN}  [4]${NC} Delete ZIVPN Account"
echo -e "${GREEN}  [5]${NC} Check ZIVPN Login"
echo -e "${GREEN}  [6]${NC} List All ZIVPN Accounts"
