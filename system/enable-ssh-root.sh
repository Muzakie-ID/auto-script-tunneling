...
# Get server IP
echo ""
echo -e "${CYAN}[1/3]${NC} Getting server information..."
...
if grep -q "^PermitRootLogin yes" /etc/ssh/sshd_config 2>/dev/null; then
    ...
    echo -e "${CYAN}[2/3]${NC} Enabling root login..."
...
# Set root password
echo ""
echo -e "${CYAN}[3/3]${NC} Setting root password..."
...
echo ""
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${YELLOW}          REBOOT (OPTIONAL)                         ${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
echo -e "${YELLOW}SSH root login is now active. You can connect immediately.${NC}"
echo -e "${YELLOW}A reboot is optional but recommended.${NC}"
echo ""
...
if [[ $reboot_choice =~ ^[Yy]$ ]]; then
    ...
    echo ""
    echo -e "${GREEN}Reboot skipped. You can reboot later with: reboot${NC}"
    echo ""
fi
